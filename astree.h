...
extern PROCFUNCDEF *make_procfuncdef (DECLLIST *optfp, TYPE *rt, BLOCK *blk);
extern DECL *make_procfunc_decl (IDENT *id, DECLLIST *optfp, TYPE *rt, BLOCK *blk);
...
extern TYPE *make_pointer_type (IDENT *id);
/* origin */
...
extern FIELD * make_field(IDENT *id, TYPE *t, int offset);
extern FIELDLIST *make_fieldlist(IDENT *id, TYPE *t, FIELDLIST *optfl);
...
extern STMTREPEAT *make_stmtrepeat (STMTLIST *sl, EXPR *e);
extern STMTCASE   *make_stmtcase   (EXPR *expr, CASELIST *list);
extern STMTLIST *make_stmtlist (STMT *s, STMTLIST *rest);
extern STMTIF *make_stmtif (EXPR *if_expr, STMT *if_then, STMT *if_else);
extern STMTFOR *make_stmtfor (IDENT *id, EXPR* ini, int dir, EXPR *to, STMT *s);

/* statement constructor functions */
/* my add */

extern STMT *make_compound_stmt(STMTLIST *sl);
extern STMT *make_case_stmt (EXPR *expr, CASELIST *casle);
extern STMT *make_if_stmt (EXPR *if_expr, STMT *if_then, STMT *if_else);
extern CASELIST *make_caselist (CASEARM *casle, CASELIST *optcasles);
extern CASEARM *make_casearm (EXPRLIST *cas_labels, STMT *s);
extern STMT *make_repeat_stmt (STMTLIST *sl, EXPR *e);
extern STMT *make_for_stmt (IDENT *id, EXPR* ini, int dir, EXPR *to, STMT *st);
